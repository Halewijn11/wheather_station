...
/* 
 * CRITICAL FIX: The Heltec library requires these exact global names 
 * to compile and link successfully, regardless of OTAA/ABP usage.
 */
...
void loop()
{
	switch( deviceState )
	{
      ...
      if(timeReq)
      {
        timeReq = true; // for testing, always add time req in every uplink
        MlmeReq_t mlmeReq;  
